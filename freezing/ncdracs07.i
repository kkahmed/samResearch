...
[Components]
 ...
 [./TCHX]
   ...
   geometry_type = Slab
   # HTC_user_option = ChurchillChu
   HT_surface_area_density = 300
 [../]

 [./Structure]
   type = PBCoupledHeatStructure
   HS_BC_type = 'Temperature Coupled'
   ...
   Ts_init = 790
   T_bc_left = 790
   name_comp_right = TCHX
   eos_right = eos
   HT_surface_area_density_right = 300
 []
