[GlobalParams] #
    global_init_P = 3.0e5
    global_init_V = 0.106421 #0.06 #0.29
    global_init_T = 892.3967
    Tsolid_sf = 1e-3
...
[Components]
  ...
  [./DHX]
    ...
    initial_V = 0.020481 #0.029349731
  ...
  [./TCHX]
    ...
    Hw_secondary = 26.9 #Tuned to match Mohamed's overall U

  	initial_V = 0.086127 #0.04855862 #0.12341942  #0.23470
