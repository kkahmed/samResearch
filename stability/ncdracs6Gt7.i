...
[Functions]
  ...
  [./Q_perturb2]
    ...
    y = '12337162 24337162 24337162'
  [../]
  [./PumpFN]
    type = PiecewiseLinear
    x = '2000  3000  1e5' #For restart from 6Gs
    y = '0.0   -1125 -1125' #y = '0.0   0.0   0.0'
  [../]
  [./PBTDVTemp]
    type = ParsedFunction
    vals = 'pipe5out'
  ...
  [./Gr_bound2]
    ...
    vals = 'TCHX_Re'
    vars = 'Re'
    value = (if(Re<=180.389,1,0))*(Re*5.797e10-3.716e12)+(if(Re<245.706,1,0))*(if(Re>180.389,1,0))*(Re*8.491e10-8.576e12)+(if(Re>=245.706,1,0))*(Re*1.472e11-2.388e13)
  [../]
[]
