...
[Functions]
  [./v_in]
    ...
    y = '0.4 0.4 0.40  0.40  0.4  0.4  0.40  0.40  0.4  0.4  0.40  0.40  0.4  0.4  0.40  0.40'
  [../]
  [./p_out]
    type = PiecewiseLinear
    x = '0   100'
  ...
  [./T_in]
    type = PiecewiseLinear
    x = '0   150 250  500 550  750  850  1100 1150 1500 1550 6000 6150 8200 8350 21600'
    y = '860 860 790  790  860  860  790  790  860  860  790  790  860  860  790  790'
  [../]
  [./htc_ext]
    type = PiecewiseLinear
    x = '0   150 250  500 550  750  850  1100 1150 1500 1550 6000 6150 8200 8350 21600'
    y = '40  40  80  80  60.0   60.0   80  80  60.0   60.0   80  80  60.0   60.0   80  80'
  [../]
  [./temp_ext]
    type = PiecewiseLinear
    x = '0   140 21600'
...
[Executioner]
  ...
  end_time = 6000.0                     # Max. physical time at the end of the simulation
